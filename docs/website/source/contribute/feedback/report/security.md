...
{{pp_meta.project.name}} takes the security and privacy of all its users and members very seriously, 
...
:::{admonition} {{pp_meta.project.name}} Security Measures 🛡
:class: seealso
...
{{pp_meta.project.name}} is a free and open-source project.
