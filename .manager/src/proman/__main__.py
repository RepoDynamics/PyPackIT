...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--repo", help="Local path to the repository's root directory.", default="./"
    )
    parser.add_argument(
        "--repo-upstream", help="Local path to the upstream repository's root directory."
    )
    ...
    parser.add_argument(
        "--remove-tokens", help="Remove all tokens read from the environment.", action="store_true"
    )
    parser.add_argument(
        "--no-validation",
